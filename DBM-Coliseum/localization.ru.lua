...
L:SetMiscLocalization({
	...
	SlowStart   = "Добро пожаловать, герои! Вы услышали призыв Серебряного Авангарда и без колебаний откликнулись на него! В этом колизее вам предстоит сразиться с опаснейшими противниками. Те из вас, кто смогут пережить испытания, войдут в ряды Серебряного Авангарда, который направится в Цитадель Ледяной Короны.",
	...
	Phase3      =
	"В воздухе повеяло ледяным дыханием следующего бойца: на арену выходит Ледяной Рев! Сражайтесь или погибните, чемпионы!",
...
L:SetOptionLocalization({
	...
	ShowNetherPowerDec    = "Показывать счетчик стаков на боссе"
})
...
L:SetMiscLocalization({
	...
	Pull20           = "АГА! Получилось! Трепещи перед всевластным Вилфредом Непопамсом, мастером призыва! Ты покорен мне, демон!"
})
...
L:SetMiscLocalization({
	...
	Ginselle        =
	"|TInterface\\WorldStateFrame\\Icons-Classes.blp:24:24:0:0:128:128:32:63.5:0:32|t Гинзелль Отразительница Гнили", -- 34449
	...
	Serissa         =
	"|TInterface\\WorldStateFrame\\Icons-Classes.blp:24:24:0:0:128:128:95:126.5:32:64|t Серисса Мрачная Кропильщица", -- 34474
...
L:SetMiscLocalization({
	...
	Raid = "|cffffffffРейд:|r ",
	Catchers = "|cffffffffЛовцы:|r ",
	Light = "|cffFFCC00Свет|r",
	Dark = "|cff9932CDТьма|r",
	None = "|cff808080-|r",
	VortexLight = "Светлая воронка",
	VortexDark = "Темная воронка",
	PactLight = "Щит Света",
	PactDark = "Щит Тьмы",
	InfoFrameOption = "Показывать информационное окно (воронки, щиты, цвета)",
})
...
L:SetOptionLocalization({
	...
	SpecWarnSpecialInstruction = "Спец-предупреждение: действия для рейда/ловцов",
	...
	InfoFrameSetPoint       = "Выравнивать информационное окно по умолчанию (по центру слева, чуть вниз)"
})
...
L:SetOptionLocalization({
	...
	TimerSubmerge             = "Отсчет времени до зарывания",
	AnnouncePColdIcons        =
	"Объявлять метки целей заклинания $spell:68510 в рейд-чат (требуются права лидера или помощника)",
	AnnouncePColdIconsRemoved =
	"Объявлять также о снятии меток с целей заклинания $spell:68510 (требуется предыдущая опция)",
