...
local timerShellCD			= mod:NewCDTimer(24.5, 38759)
local timerBlastCD			= mod:NewCDTimer(26.5, 38760)
...
function mod:OnCombatStart(delay)
	timerBlastCD:Start(23 - delay)
	timerShellCD:Start(15 - delay)
	firstBlast = true
end
